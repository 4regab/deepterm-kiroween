...
export default function PracticePage() {
    ...
    const settings = useStudySettingsStore((state) => state.practiceSettings);
                    ...
                    {stage === "take" && currentQuestion && (
                        <motion.div key="take" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className={`font-sora font-semibold ${textColor}`}>{isSpooky ? "Dark Ritual" : "Practice Test"}</span>
                                <button
                                    onClick={() => setShowSettings(true)}
